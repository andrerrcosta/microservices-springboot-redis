...
public class AMQPConfiguration {
    ...
    public TopicExchange agendaTopicExchange(@Value("${amqp.exchange.scheduler}") final String exchangeName) {
    ...
    @Bean
    public Queue agendaQueue(@Value("${amqp.queue.scheduler}") final String queueName) {
    ...
    public Binding handleAnalyticsReport(final Queue panelQueue,
            @Qualifier("schedulerExchange") final TopicExchange exchangeName,
